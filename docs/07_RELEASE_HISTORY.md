...
| v1.0.3 | 2026-01-23 | `40c7c99` | 심사 반려 대응(UI/UX), 운명 이미지 생성 | 🚀 심사 요청 중 |

---

## 🏷️ v1.0.3 - 심사 반려 대응 및 기능 확장 (2026-01-23)

### Git 정보
- **커밋**: `40c7c99`
- **커밋 메시지**: `feat: 프로필 운명 이미지 생성 기능 추가` / `fix: 토스 심사 반려 해결`
...
| **공유 링크 404** | 존재하지 않는 URL 하드코딩 | `window.location.href`를 사용하도록 수정 |

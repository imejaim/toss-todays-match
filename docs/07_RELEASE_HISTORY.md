...
| v1.0.5 | 2026-01-24 | `6d0a19f+` | 토스 공식 공유 API 적용 | 🚀 심사 준비 |
| v1.0.6 | 2026-01-24 | `(TBD)` | 리포트 로딩 UX 개선 (Hotfix) | 🚀 긴급 배포 |

---

## 🏷️ v1.0.6 - 리포트 로딩 UX 개선 (2026-01-24)

### Git 정보
- **주요 변경**: 광고 종료 직후 화면 전환 및 로딩 UI 추가

### 🛠️ 핫픽스 (Hotfix)
| 이슈 | 문제 현상 | 해결 |
|------|------|------|
| **리포트 로딩 지연** | 광고 종료 후 2초간 화면 멈춤 현상 | **즉시 잠금 해제** 후 데이터 로딩 로직 변경 (`fetchReport` 분리) |
| **UX 불확실성** | 버튼 누름 멈춤 오해 | **"운세를 정밀 분석하고 있어요"** 로딩 화면 추가 |

...
::: tip  꼭 확인해 주세요
앱인토스 콘솔은 [토스 비즈니스 회원가입](https://business.toss.im/account/sign-up)이 필요하고,\
**만 19세 이상** **토스 비즈니스 회원**만 접근할 수 있어요.\
...
![](/assets/registering-app-2.Dkdrf4HJ.png)
...
![](/assets/registering-app-game.D3SbjEeS.png)
...
::: tip 자체등급분류사업자(오픈마켓)은 다음과 같으며, 그외 오픈마켓의 경우 불가해요.
...
토스 로그인, 수익화 기능을 사용하려면 사업자 인증이 필요해요.\

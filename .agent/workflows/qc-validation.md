...
| 오늘의 운세 | `/today-fortune` | 점수, 키워드, 메시지 |
| 프리미엄 보고서 | `/premium-report` | 💎 아이콘, 광고 버튼, AI 분석 결과 |
| 개인정보 처리방침 | `/privacy` | 정책 내용 표시 |

### 5-3. 스크린샷 보관
검증 완료 후 각 페이지 스크린샷을 `docs/assets/` 폴더에 저장하여 증거로 보관합니다.

## 6. 실행 규칙 (Rules)
- **모든 배포(Deploy) 전에는 반드시 위 2, 3, 4, 5번 과정을 통과해야 합니다.**
